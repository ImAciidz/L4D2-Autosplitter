...
startup
{
	...
	settings.Add("version2208", false, "Version 2.2.0.8", "version2203");
	settings.SetToolTip("version2208", "Newest as of Dec 1st 2020");
...
init
{
	...
	vars.Version2208= memory.ReadString(modules.Where(m => m.ModuleName == "engine.dll").First().BaseAddress + 0x69AF50, 7);
